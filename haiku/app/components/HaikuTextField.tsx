...
const MyAnimatedTextarea: React.FC = () => {
    ...
    return (
        <div style={{ position: 'relative' }}>
            <textarea onInput={handleInput} style={{ zIndex: 1 }} className={"font-mono h-64 leading-5 w-full"} />
            <canvas ref={canvasRef} style={{ position: 'absolute', top: 0, left: 0, pointerEvents: 'none' }} width={window.innerWidth} height={window.innerHeight}></canvas>
        </div>
    );
};
